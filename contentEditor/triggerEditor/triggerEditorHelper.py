...
from extra.sharedObjects import constants, triggerData
from contentEditor.contentEditorShared import objectConstants, metaData

class triggerEditorHelper:

    def __init__(self, editor):
        self.editor = editor
        self.workData = triggerData("Work\\TriggerEditor")
    ...
    def clearTriggerData(self):
        self.workData.clear()
        #self.workData.mergeData(constants.getBaseObjectData())

    def addTriggerData(self, trgData):
        self.workData.mergeData(trgData)

    def setTriggerData(self, trgData):
        self.clearTriggerData()
        self.addTriggerData(trgData)
